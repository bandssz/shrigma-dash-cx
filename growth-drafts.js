...
const GR={
  ...
  valida(r){
    ...
    if(r.canal==='email'){
      ...
      if(!envelope&&/<\s*(script|iframe|object|embed|form|input|base|meta)\b|\bon[a-z]+\s*=|javascript\s*:|data\s*:/i.test(r.corpo||''))erros.push('Remova scripts, formulários e conteúdo interativo do e-mail.');
