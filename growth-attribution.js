 ...
 function campaigns(api,b,a,z,channel='todos',search=''){
  ...
  for(const v of map.values()){
   v.members=v.members.map(m=>{
    ...
    return {...m,in_period:sent&&inPeriod(day(m.enviado_em),a,z),future:!sent,shared,tracked,result:sent&&tracked&&exclusive.length?sum(uniqueMatches):null};
