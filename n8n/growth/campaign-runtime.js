...
const REQUEST_KEYS=new Set(['acao','brand','id','definition','expected_version','idempotency_key','confirm']);
const STORE_ACTIONS=new Set(['claim','get','provider','finish','validation_get','validation_set','validation_invalidate']);
const PROVIDER_ACTIONS=new Set(['catalog','list','get','update','schedule','cancel']);
