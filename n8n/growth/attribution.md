...
O vínculo temporal é calculado em uma projeção materializada com atualização a cada cinco minutos e trava contra execução concorrente. A API lê os agregados dessa projeção e informa checked_at. Pagamentos e receita total conservam sua coleta própria; o vínculo de um novo pedido pode aparecer na atualização seguinte.
