...
A landing é `/webhook/olivas-nps`; votos e comentários usam endpoints próprios com assinatura da marca. A nota é salva antes do ClickUp. Comentários aguardando a sincronização da nota são processados a cada minuto; resultados externos incertos não são repetidos automaticamente. O lembrete verifica elegíveis diariamente às 19h de Brasília, após 3 dias sem resposta, 1 contato por vez. Só envia a assinantes habilitados e confirmados nas listas 40–43, com reserva por pedido/etapa, pausa da jornada e intervalo de 45 dias.
