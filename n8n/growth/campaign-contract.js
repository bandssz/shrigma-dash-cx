...
const CampaignContract=(()=>{
 const VERSION='crm-campaign-v1',BRANDS={aristo:'oaristocrata.com',fish:'fishermans.com.br'};
 ...
 function normalize(input){
  ...
  if(!Object.hasOwn(BRANDS,input.brand))error('BRAND_INVALID','Escolha Fishermans ou O Aristocrata.','brand');
 ...
 return {VERSION,BRANDS,normalize,checkCatalog,prepare,schedule,request};
})();
