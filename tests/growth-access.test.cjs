...
function boot({legacy='',onRead=()=>{}}={}){
 ...
 for(const f of ['growth-access.js','growth-brand-state.js','growth-templates-api.js','growth-drafts-ui.js','growth-control.js','growth-builder.js','n8n/growth/campaign-tracking.js','campaign-contract.js','growth-campaign-api.js','growth-campaign-editor.js'])vm.runInContext(fs.readFileSync(path.join(root,f),'utf8'),ctx,{filename:f});
