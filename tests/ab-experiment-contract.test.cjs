...
function evidence(){return {contract:AB.CONTRACT,test_id:config().test_id,protocol:config(),integrity:{allocation_complete:true,assignment_disjoint:true,transport_bound:true,transport_continuous:true,tracking_continuous:true,source_complete:true},arms:[{arm:'a',campaign_id:1,allocated:10000,unique_clickers:100,native_sent:9990,revoked:10,unknown:0,finished_before_deadline:true},{arm:'b',campaign_id:2,allocated:10000,unique_clickers:2000,native_sent:9800,revoked:200,unknown:0,finished_before_deadline:true}],window_start:'2026-09-25T12:00:00Z',window_end:'2026-09-26T12:00:00Z',as_of:'2026-09-26T12:00:00Z'};}
